...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-16 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center space-y-6 pt-8 md:pt-12 pb-4">
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {technologies.map((tech) => (
              <Card key={tech.name} className="shadow-sm hover:shadow-md transition-shadow duration-300 border-neutral-200/60 dark:border-neutral-800/60 bg-white/60 dark:bg-neutral-900/40 backdrop-blur-xl rounded-2xl group cursor-default">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            {teamMembers.map((member) => (
              <Card key={member.name} className="flex items-center gap-5 p-5 shadow-[0_4px_20px_rgb(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgb(255,255,255,0.01)] bg-white/70 dark:bg-neutral-900/60 backdrop-blur-2xl border-neutral-200/50 dark:border-neutral-800/50 rounded-[1.5rem] transition-all duration-300 hover:-translate-y-1 cursor-default group">
